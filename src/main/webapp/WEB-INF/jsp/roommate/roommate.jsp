...
<link rel="stylesheet" href="/css/roommate.css?<%=System.currentTimeMillis()%>">
...
<!-- top -->
	...
	<div class="text-center">
		<img alt="apartment" src="/image/apartment.png" style="width: 30%;">
	</div>
	
	<!-- countryList  -->
	<div class="m-auto text-center countryLabel" style="padding-top: 60px;">
		<label for="country">나라를 선택해주세요</label>
	</div>
	...
	<p class="text-center cityTitle">도시명</p>
    <!-- country Cities -->	
	<div class="col-11 m-auto mt-4 cityBoard">
