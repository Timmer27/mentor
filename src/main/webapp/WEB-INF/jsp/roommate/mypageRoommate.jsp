			...
			<div class="col-8 m-auto mx-4" style="height: 63rem;">
				<div class="col-12">
					<div class="col-12 d-flex flex-column">
						...
						<span class="subTitle savePost" style="">저장한 글</span>
							<div class="mypageSub infoBox"  style="height: 18rem;">
								<div id="owlCaraouselContainer"></div>	
								<div class="d-flex px-4 roommateSub owl-carousel">
									<c:forEach var="savePost" items="${savePost}">
										<a class="shadow mx-3 main_box" href="/roommate/brl?num=${savePost.num}">
											<div class="d-flex flex-column list_box">
												<div class="img_box">
													<img alt="썸네일" src="/upload/${savePost.thumbPic}" class="img_list">
												</div>
